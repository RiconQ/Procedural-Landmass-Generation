...
public class MapGenerator : MonoBehaviour
{
    ...
    private void Awake()
    {
        m_falloffMap = FalloffGenerator.GenerateFalloffMap(MAP_CHUNK_SIZE);
    }
    private void Update()
    {
    ...
    private MapData GenerateMapData(Vector2 center)
    {
        var noiseMap = Noise.GenerateNoiseMap(
            MAP_CHUNK_SIZE + 2, MAP_CHUNK_SIZE + 2, m_seed, m_noiseScale, m_octaves, m_persistance, m_lacunarity, center + m_offset, m_normalizeMode);
